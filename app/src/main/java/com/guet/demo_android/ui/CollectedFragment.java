...
import com.guet.demo_android.databinding.FragmentCollectedBinding;
...
public class CollectedFragment extends Fragment {
    ...
    private FragmentCollectedBinding binding; // 使用ViewBinding声明绑定对象
    private String url = "http://47.107.52.7:88/member/photo/collect";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = binding.recyclerviewCollected;
